            ...
            <div className="relative z-20 flex items-center justify-center h-full text-white">
              <div className="text-center max-w-4xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <Button
                    size="lg"
                    className="bg-amber-500 hover:bg-amber-600 text-black font-medium px-8 py-3 text-lg rounded-full"
                    onClick={() => {
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">
                  Haz clic en el botón para agendar tu sesión directamente con Joaquín Carma por WhatsApp.
                </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <Accordion type="single" collapsible defaultValue="item-3" className="space-y-4">
                ...
                <AccordionItem
                  value="item-1"
                  className="border border-gray-200 rounded-2xl px-6 py-2 data-[state=open]:bg-amber-50"
                >
                  ...
                  <AccordionContent className="pb-4">
                    <div className="bg-gray-100 rounded-xl p-4 mt-2">
                      <p className="text-gray-600 leading-relaxed">
                        Una sesión de meditación contemplativa es un espacio dedicado a la práctica profunda de la
                        atención plena y la autoexploración. Durante estas sesiones, te guiamos a través de técnicas
                        específicas para calmar la mente, observar tus pensamientos sin juicio y conectar con tu
                        sabiduría interior.
                      </p>
                    </div>
                  </AccordionContent>
                ...
                >
                  ...
                  <AccordionContent className="pb-4">
                    <div className="bg-gray-100 rounded-xl p-4 mt-2">
                      <p className="text-gray-600 leading-relaxed">
                        Sí, todas nuestras sesiones se realizan de forma virtual a través de plataformas seguras como
                        Zoom o Google Meet. Solo necesitas un espacio tranquilo, una conexión estable a internet y la
                        disposición para sumergirte en la práctica desde la comodidad de tu hogar.
                      </p>
                    </div>
                  </AccordionContent>
                </AccordionItem>
                ...
                >
                  ...
                  <AccordionContent className="pb-4">
                    <div className="bg-gray-100 rounded-xl p-4 mt-2">
                      <p className="text-gray-600 leading-relaxed">
                        Los beneficios a largo plazo incluyen una mayor estabilidad emocional, mejor manejo del estrés,
                        incremento en la autoconciencia, relaciones más saludables, y una sensación general de paz y
                        propósito en la vida. La práctica constante te ayuda a desarrollar herramientas internas
                        duraderas para el bienestar.
                      </p>
                    </div>
                  </AccordionContent>
                </AccordionItem>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              <div className="mb-8">
                <div className="flex items-center mb-4">
                  <span className="text-amber-500 mr-2">✦</span>
                  <span className="text-amber-600 text-sm font-medium">Nuestros Testimonios</span>
                </div>
                <h2 className="text-4xl font-bold text-gray-800 leading-tight">
              ...
              <div className="grid grid-cols-2 gap-4">
                {/* Top Left - Lucia González (Amber background) */}
                <Card className="bg-amber-200 border-none rounded-2xl p-6">
                  <CardContent className="p-0">
                    <p className="text-gray-800 text-sm leading-relaxed mb-6 italic">
                      "Gracias a las sesiones, pude mejorar mi bienestar físico y mental. Ahora tengo más energía y me
                      siento más equilibrado."
                    </p>
                    <div className="flex items-center">
                      <Image
                        src="/placeholder.svg?height=40&width=40&text=LG"
                        alt="Lucia González"
                        width={40}
                        height={40}
                ...
                {/* Top Right - Juan Martinez (White background) */}
                <Card className="bg-white border border-gray-200 rounded-2xl p-6">
                  <CardContent className="p-0">
                    <p className="text-gray-600 text-sm leading-relaxed mb-6 italic">
                      "Con las sesiones entendí que la meditación no era lo que yo pensaba, sino algo mucho mejor. Me
                      ayudó a encontrar paz y claridad."
                    </p>
                    <div className="flex items-center">
                      <Image
                ...
                {/* Bottom Left - Alicia Fernández (White background) */}
                <Card className="bg-white border border-gray-200 rounded-2xl p-6">
                  <CardContent className="p-0">
                    <p className="text-gray-600 text-sm leading-relaxed mb-6 italic">
                      "Las sesiones no solo me ayudaron con el estrés, sino que también mejoraron mi calidad de sueño.
                      Ahora me siento renovada."
                    </p>
                    <div className="flex items-center">
                      <Image
                        src="/placeholder.svg?height=40&width=40&text=AF"
                        alt="Alicia Fernández"
                        width={40}
                        height={40}
                        className="rounded-full object-cover mr-3"
                      />
                ...
                {/* Bottom Right - Pedro Rodriguez (White background) */}
                <Card className="bg-white border border-gray-200 rounded-2xl p-6">
                  <CardContent className="p-0">
                    <p className="text-gray-600 text-sm leading-relaxed mb-6 italic">
                      "Gracias a las sesiones, entendí cómo controlar mis emociones y tener una vida más equilibrada.
                      ¡Recomiendo 100%!"
                    </p>
                    <div className="flex items-center">
                      <Image
                        src="/placeholder.svg?height=40&width=40&text=PR"
                        alt="Pedro Rodriguez"
                        width={40}
                        height={40}
                        className="rounded-full object-cover mr-3"
            ...
            <div className="relative">
              ...
              <div className="relative mb-6">
                <Image
                  src="/placeholder.svg?height=300&width=400&text=Persona+meditando+de+espaldas"
                  alt="Persona meditando de espaldas"
                  width={400}
                  height={300}
                  className="rounded-3xl object-cover w-full"
                />
